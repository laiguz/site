<section class="p-6 dark:bg-gray-800 dark:text-gray-50">
    <form wire:submit.prevent="update()" wire.loading.attr='disable' class="container flex flex-col mx-auto space-y-12">
            ...
            <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                ...
                <div class="col-span-full">
                    ...
                    <textarea class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900"
                        maxlength="150" wire:model="meta_description" rows="5">{{ old('meta_description', $meta_description ?? '') }}</textarea>
                </div>
                <div class="col-span-full">
                    <label for="meta_tags">Palavras chave (80 caracteres)</label>
                    <textarea class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900"
                        maxlength="80" wire:model="meta_tags" rows="5">{{ old('meta_tags', $meta_tags ?? 'As palavras chaves devem ser separadas por ","') }}</textarea>
                </div>
                {{-- <div class="col-span-full">
